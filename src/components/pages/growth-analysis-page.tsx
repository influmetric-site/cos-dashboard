...
const weeklyGrowthData = [
  { week: 'H01', followers: 2100, reach: 1400 },
  { week: 'H02', followers: 3400, reach: 2800 },
  { week: 'H03', followers: 3100, reach: 2100 },
  { week: 'H04', followers: 4800, reach: 4200 },
  { week: 'H05', followers: 5200, reach: 4900 },
  { week: 'H06', followers: 6400, reach: 5800 },
]
...
const analysisCards = [
  {
    ...
    longDesc: "Haftalık Büyüme Hızı, yedi günlük periyottaki takipçi değişim katsayısını temsil eder. Hafta 06'daki sıçrama, yayınlanan son lifestyle içeriklerinin keşfet etkisinden kaynaklanmaktadır.",
    icon: TrendingUp,
    params: { "H/H Değişim": "+18%", "Zirve": "Salı", "Trend": "Boğa" }
  },
  {
    id: "projeksiyon",
    ...
    longDesc: "COS® motoru, mevcut içerik takviminle uyumlu olarak önümüzdeki hafta 7.200 ile 8.100 arasında yeni organik takipçi girişi beklemektedir.",
    icon: Zap,
  ...
  },
  {
    ...
    longDesc: "Gelen takipçilerin %98.2'sinin yaşam tarzı ve günlük vlog nişiyle doğrudan ilgili olduğu saptandı. Bu, doğru hedeflemeyi kanıtlar.",
    icon: Users,
    params: { "Aktiflik": "Yüksek", "Segment": "Premium", "Bot": "0" }
  }
]
...
export function GrowthAnalysisPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-10 animate-in fade-in slide-in-from-bottom-8 duration-1000 pb-20 text-left">
      ...
      {/* ÜST BİLGİ - Aşama 02 ve Sadeleştirilmiş Header */}
      <div className="flex justify-between items-end border-b border-white/5 pb-8">
        <div className="space-y-3 text-left">
          ...
          <h2 className="text-5xl font-black text-white italic tracking-tighter uppercase leading-none text-left">
            Büyüme <span className="text-blue-500 text-left">Metrikleri</span>
          </h2>
          <p className="text-[10px] text-gray-500 font-bold uppercase tracking-[0.2em] italic text-left">
            Influmetric Veri Madenciliği ve Tahminleme Arayüzü
          </p>
        </div>
      </div>
          ...
          <div className="relative bg-[#0B0F17]/80 border border-white/5 p-12 rounded-[3.5rem] backdrop-blur-xl overflow-hidden transition-all duration-700 hover:border-blue-500/20">
            ...
            <div className="relative z-10 flex justify-between items-center mb-12 text-left">
              ...
              <div className="text-right">
                ...
                <p className="text-2xl font-black text-blue-400 italic tracking-tighter text-right">21,100</p>
              </div>
            </div>
        ...
        <div className="col-span-12 lg:col-span-4 space-y-5">
          {analysisCards.map((card) => (
            <div 
              ...
              className={`group transition-all duration-700 relative overflow-hidden border focus-visible:ring-2 focus-visible:ring-blue-500 outline-none ${
                expandedId === card.id 
            ...
            >
              <div className="p-8 cursor-pointer flex flex-col gap-6">
          ...
          <div className="p-10 rounded-[3.5rem] bg-gradient-to-br from-blue-600 to-indigo-800 text-white shadow-2xl shadow-blue-900/40 relative overflow-hidden group">
              ...
              <div className="relative z-10 space-y-4 text-left">
                  ...
                  <p className="text-[13px] font-bold italic opacity-90 leading-relaxed text-left">
                      Influmetric COS® sistemi, <span className="text-white font-black uppercase text-left">"Sürdürülebilir Lifestyle ve Vlog"</span> segmentinde yüksek bir etkileşim boşluğu saptadı. Kitle analizi verilerine göre, bu dikeyde yapılacak bir içerik serisi, ana nişinle <span className="underline decoration-blue-300 decoration-2 underline-offset-4 font-black text-left">94% uyum sağlayarak</span> mevcut erişimini hızla yukarı taşıyabilir.
                  </p>
              </div>
          </div>
        </div>
